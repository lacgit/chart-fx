 ...
 * axis.
 */
public final class FinancialCategoryAxis extends DefaultFinancialAxis {
    ...
    private final ObjectProperty<ObservableList<String>> categories = new ObjectPropertyBase<>() {
        ...
        public Object getBean() {
            return FinancialCategoryAxis.this;
        }
     ...
     */
    public FinancialCategoryAxis(final ObservableList<String> categories) {
     ...
     */
    public FinancialCategoryAxis(final String axisLabel) {
        super(axisLabel);
     ...
     * @param categories List of the categories for this axis
     */
    public FinancialCategoryAxis(final String axisLabel, final ObservableList<String> categories) {
