...
public class CandleStickDateTimeCategoryRenderer extends AbstractFinancialRenderer<CandleStickDateTimeCategoryRenderer> implements Renderer, RendererPaintAfterEPAware {
    ...
    public CandleStickDateTimeCategoryRenderer(boolean paintVolume) {
    ...
    public CandleStickDateTimeCategoryRenderer() {
        this(false);
    }
    ...
    @Override
    protected CandleStickDateTimeCategoryRenderer getThis() {
        return this;
    }
