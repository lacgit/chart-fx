...
public abstract class AbstractFinancialIndexRenderer<R extends Renderer> extends AbstractDataSetManagement<R> implements Renderer {
    ...
    protected void applyLocalYRange(DataSet ds, Axis yAxis, double xmin, double xmax) {
        ...
        for (int i = (int) xmin; i < Math.min(xmax, ds.getDataCount()); i++) {
