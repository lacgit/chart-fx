 ...
 * @author afischer
 */
public class FinancialAdvancedCandlestickDateTimeIndexSample extends AbstractBasicFinancialApplication {
    ...
    protected void prepareRenderers(XYChart chart, OhlcvDataSet ohlcvDataSet, DefaultDataSet indiSet) {
        ...
        var candleStickRenderer = new CandleStickDateTimeIndexRenderer(true);
