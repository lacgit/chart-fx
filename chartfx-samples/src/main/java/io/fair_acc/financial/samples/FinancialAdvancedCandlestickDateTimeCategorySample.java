...
import io.fair_acc.chartfx.renderer.spi.financial.CandleStickDateTimeCategoryRenderer;
...
import io.fair_acc.financial.samples.AbstractBasicFinancialApplication;
 ...
 * @author afischer
 */
public class FinancialAdvancedCandlestickDateTimeCategorySample extends AbstractBasicFinancialApplication {
    ...
    protected Scene prepareScene() {
        ...
        final var chart = getDefaultFinancialDateTimeCategoryTestChart(FinancialColorSchemeConstants.SAND);
    ...
    protected void prepareRenderers(XYChart chart, OhlcvDataSet ohlcvDataSet, DefaultDataSet indiSet) {
        ...
        var candleStickRenderer = new CandleStickDateTimeCategoryRenderer(true);
