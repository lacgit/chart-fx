 ...
 */
public class CategoryOhlcv implements IOhlcv {
    ...
    public static IOhlcv createShellCopyRangedOHLCV(CategoryOhlcv rOHLCV) {
        CategoryOhlcv rangedOHLCV = new CategoryOhlcv();
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        CategoryOhlcv other = (CategoryOhlcv) obj;
        if (assetName == null) {
